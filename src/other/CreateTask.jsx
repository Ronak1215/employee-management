...
const CreateTask = () => {
  ...
  return (
    <div className='bg-[#1e1e1e] p-6 rounded-xl shadow-md shadow-black/10 mt-6'>
      ...
      <form onSubmit={submitHandler} className='md:flex flex-wrap w-full items-start justify-between'>
        <div className='md:w-1/2'>
          <div className='mb-4'>
            ...
            <input
              ...
              className='w-full md:w-4/5 px-4 py-2 rounded-lg border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all'
              type="text"
